...
- [0.x patch version bumps](#0x-patch-version-bumps)
  ...
  - [`@backstage/plugin-nomad` (0.1.15 → 0.1.16)](#backstageplugin-nomad-0115--0116)
...
### `@backstage/plugin-linguist-backend` (0.5.15 → [0.5.16](../../changelogs/@backstage/plugin-linguist-backend.md#0516))
...
### `@backstage/plugin-nomad` (0.1.15 → [0.1.16](../../changelogs/@backstage/plugin-nomad.md#0116))
...
### `@backstage/plugin-nomad-backend` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-nomad-backend.md#0120))
...
### `@backstage/plugin-pagerduty` (0.7.6 → [0.7.7](../../changelogs/@backstage/plugin-pagerduty.md#077))
